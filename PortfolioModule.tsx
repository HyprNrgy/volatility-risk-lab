        ...
        <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-xl col-span-1 lg:col-span-2">
          ...
          <div className="mt-4 flex justify-between items-center text-sm">
            ...
            <span className={`font-mono font-medium ${Math.abs(assets.reduce((a, b) => a + b.weight, 0) - 100) > 0.1 ? 'text-red-400' : 'text-emerald-400'}`}>
              {assets.reduce((a, b) => a + b.weight, 0).toFixed(0)}%
            </span>
          </div>
        </div>
              ...
              <div className="h-72">
                <ResponsiveContainer width="100%" height="100%">
                  <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                    ...
                    <XAxis type="number" dataKey="volatility" name="Volatility" stroke="#a1a1aa" tickFormatter={(v) => (v * 100).toFixed(0) + '%'} domain={['auto', 'auto']} />
                    <YAxis type="number" dataKey="return" name="Return" stroke="#a1a1aa" tickFormatter={(v) => (v * 100).toFixed(0) + '%'} domain={['auto', 'auto']} />
              ...
              <div className="h-64">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={data.individual.map((a: any) => ({
                    ...
                    <YAxis yAxisId="left" stroke="#a1a1aa" fontSize={12} tickFormatter={(v) => v.toFixed(0) + '%'} />
                    <YAxis yAxisId="right" orientation="right" stroke="#a1a1aa" fontSize={12} tickFormatter={(v) => v.toFixed(0) + '%'} />
                    <Tooltip 
